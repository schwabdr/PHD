...
For the three models trained here on Mal_Img dataset I got the following:
All trained for 40 epochs

.03 (8/255) Pert: resnet-mal-MIAT.03
--------Evaluate the target model--------
Test:  Accuracy: 429/934 (45.93%), Robust Accuracy: 380/934 (40.69%)
Test: Natural MI Right: -n: 287.9790, -a: 278.4163
Test: Natural MI Wrong: -n: nan, -a: nan
Test: Adv MI Right: -n: 111.2279, -a: 112.8329
Test: Adv MI Wrong: -n: nan, -a: nan

.1 Pert: resnet-mal-MIAT.1
--------Evaluate the target model--------
Test:  Accuracy: 405/934 (43.36%), Robust Accuracy: 324/934 (34.69%)
Test: Natural MI Right: -n: nan, -a: nan
Test: Natural MI Wrong: -n: nan, -a: nan
Test: Adv MI Right: -n: nan, -a: nan
Test: Adv MI Wrong: -n: nan, -a: nan

.25 Pert: resnet-mal-MIAT.25
--------Evaluate the target model--------
Test:  Accuracy: 701/934 (75.05%), Robust Accuracy: 715/934 (76.55%)
Test: Natural MI Right: -n: 4.7013, -a: 4.7274
Test: Natural MI Wrong: -n: 3.8443, -a: 3.7872
Test: Adv MI Right: -n: 4.8154, -a: 4.5583
Test: Adv MI Wrong: -n: 3.0041, -a: 2.7263
...
def main():
    ...
    local_n.load_state_dict(torch.load(os.path.join(args.SAVE_MODEL_PATH, 'local_n_mal.03')))
    global_n.load_state_dict(torch.load(os.path.join(args.SAVE_MODEL_PATH, 'global_n_mal.03')))
    local_a.load_state_dict(torch.load(os.path.join(args.SAVE_MODEL_PATH, 'local_a_mal.03')))
    global_a.load_state_dict(torch.load(os.path.join(args.SAVE_MODEL_PATH, 'global_a_mal.03')))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print('================================================================')
    name = 'resnet-mal-MIAT.03' #not pretrained resnet used to start
    print(40*'=')

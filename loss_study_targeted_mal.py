...
def main():
    ...
    testset=data_micraft_dataset(img_path=args.nat_img_test_mal, clean_label_path=args.nat_label_test_mal, transform=trans_test)
    ...
    print(f"This is eval_tests03_mal - but from - loss_study_targeted_mal.py")
    #next three lines are notes from CIFAR dataset.
    ...
    print(f"Loss function used is MI_loss_test01")
    ...
    #               0        1         2        3         4        5
    model_fns = [std_res, miat_res, local_n, global_n, local_a, global_a]
    loss, acc, acc_adv = eval_loss(model_fns, device, test_loader)
